...
<head>
    ...
    <title>SprachenMeister - Hard Vokabeln</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="library-content">
        ...
        <div class="learning-options">
            <div class="option-card" onclick="window.location='hardVocKarten.php'">
            ...
            <div class="option-card" onclick="window.location='hardVocSchreiben.php'">
                <div class="option-icon">
            ...
            <div class="option-card" onclick="window.location='hardVocTest.php'">
                <div class="option-icon">
