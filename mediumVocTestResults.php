...
<head>
    ...
    <title>SprachenMeister - Medium Testergebnisse</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="library-header">
        <h1>Dein Medium Testergebnis</h1>
    ...
    <div class="library-content">
        ...
        <div class="text-center mt-4">
            <a href="mediumVoc.php" class="btn btn-outline-secondary me-2">Zurück zur Übersicht</a>
            <a href="mediumVocTest.php" class="btn btn-primary">Neuen Test starten</a>
        </div>
    </div>
