...
<head>
    ...
    <title>SprachenMeister - Medium Vokabeln</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="library-content">
        ...
        <div class="learning-options">
            <div class="option-card" onclick="window.location='mediumVocKarten.php'">
            ...
            <div class="option-card" onclick="window.location='mediumVocSchreiben.php'">
                <div class="option-icon">
            ...
            <div class="option-card" onclick="window.location='mediumVocTest.php'">
                <div class="option-icon">
