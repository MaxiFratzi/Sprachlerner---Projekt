...
$sql = "SELECT COUNT(*) as total FROM woerterm"; // Medium vocabulary table
...
<body>
    ...
    <div class="library-header">
        <h1>Medium Vokabeltest starten</h1>
    ...
    <div class="library-content">
        <?php if ($total_vocab < 5): ?>
            <div class="text-center py-5">
                ...
                <a href="mediumVoc.php" class="btn btn-primary mt-3">Zurück zur Übersicht</a>
            </div>
        <?php else: ?>
            <form action="mediumVocTestRun.php" method="POST">
                <div class="mb-4">
                ...
                <div class="text-center mt-5">
                    <a href="mediumVoc.php" class="btn btn-outline-secondary me-2">Abbrechen</a>
