...
$sql = "SELECT COUNT(*) as total FROM woertere";
...
<head>
    ...
    <title>SprachenMeister - Vokabeltest</title>
    <!-- Bootstrap CSS -->
...
<body>
    ...
    <div class="library-content">
        ...
        <?php else: ?>
            <form action="easyVocTestRun.php" method="POST">
                <div class="mb-4">
                ...
                <div class="text-center mt-5">
                    <a href="easyVoc.php" class="btn btn-outline-secondary me-2">Abbrechen</a>
