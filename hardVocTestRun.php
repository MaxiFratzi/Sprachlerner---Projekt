...
if (!isset($_POST['vocabCount']) || !is_numeric($_POST['vocabCount']) || $_POST['vocabCount'] < 5) {
    header("Location: hardVocTest.php");
    exit();
}
...
$sql = "SELECT id, englisch, deutsch FROM woerterh ORDER BY RAND() LIMIT ?"; // Hard vocabulary table
...
<body>
    ...
    <div class="library-header">
        <h1>Fortgeschrittenen Vokabeltest</h1>
    ...
    <div class="library-content">
        ...
        <form id="testForm" action="hardVocTestResults.php" method="POST">
